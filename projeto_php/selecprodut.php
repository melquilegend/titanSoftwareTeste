...
$edit_id = (int)$_GET['select'];
$sql="SELECT produto.idprod, produto.nome, produto.cor, preco.idpreco, preco.preco FROM  produto LEFT JOIN preco ON produto.idpreco = preco.idpreco WHERE idprod='$edit_id'";
 ...
 <head>
 	...
 	<title><?=$eproduto['nome'];?></title>
 </head>
 <body>
 <h1>Nome do Produto: <?=$eproduto['nome'];?></h1>
 <p>Cor: <?=$eproduto['cor'];?></p>
 <?php 
